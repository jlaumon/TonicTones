...
#ifndef LDRFORMATSLOADER_H
#define LDRFORMATSLOADER_H

#include <QtGui>
#include <ImageLoader.h>

class LdrFormatsLoader : public ImageLoader
{
public:
...
class LdrFormatsLoaderFactory : public QObject, public ImageLoaderFactory
{
    Q_OBJECT
